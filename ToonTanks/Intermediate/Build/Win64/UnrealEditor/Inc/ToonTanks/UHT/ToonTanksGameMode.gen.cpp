...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AToonTanksGameMode_StartGame_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//Esto nos permitira crear un evento en blueprint\n" },
		{ "ModuleRelativePath", "ToonTanksGameMode.h" },
		{ "ToolTip", "Esto nos permitira crear un evento en blueprint" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AToonTanksGameMode_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AToonTanksGameMode_StartGame, "StartGame" }, // 314015236
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AToonTanksGameMode, AToonTanksGameMode::StaticClass, TEXT("AToonTanksGameMode"), &Z_Registration_Info_UClass_AToonTanksGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AToonTanksGameMode), 3637131474U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_821035292(TEXT("/Script/ToonTanks"),
		Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_ToonTanksGameMode_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
