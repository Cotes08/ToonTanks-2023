...
// End Cross Module References
	DEFINE_FUNCTION(UHealthComponent::execDamageTaken)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->DamageTaken(Z_Param_DamagedActor,Z_Param_Damage,Z_Param_DamageType,Z_Param_Instigator,Z_Param_DamageCause);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_DamageCause = { "DamageCause", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(HealthComponent_eventDamageTaken_Parms, DamageCause), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::NewProp_DamageCause,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHealthComponent_DamageTaken_Statics::Function_MetaDataParams[] = {
		{ "Comment", "/* El DamageType es por si necesitamos algun tipo de da\xc3\xb1o en especial, en este proyecto no es el caso pero igualmente necesitamos la varaible\n\x09   El Instigator es el controlador encargado del da\xc3\xb1o, es decir, lo que controla al personaje que hace da\xc3\xb1o\n\x09   El DamageCause es el actor que ha realizado el da\xc3\xb1o*/" },
		{ "ModuleRelativePath", "HealthComponent.h" },
		{ "ToolTip", "El DamageType es por si necesitamos algun tipo de da\xc3\xb1o en especial, en este proyecto no es el caso pero igualmente necesitamos la varaible\n         El Instigator es el controlador encargado del da\xc3\xb1o, es decir, lo que controla al personaje que hace da\xc3\xb1o\n         El DamageCause es el actor que ha realizado el da\xc3\xb1o" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHealthComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHealthComponent_DamageTaken, "DamageTaken" }, // 3350359532
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_HealthComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHealthComponent, UHealthComponent::StaticClass, TEXT("UHealthComponent"), &Z_Registration_Info_UClass_UHealthComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHealthComponent), 82076357U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_HealthComponent_h_2868342297(TEXT("/Script/ToonTanks"),
		Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ProyectosUnreal5_ToonTanks_Source_ToonTanks_HealthComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
